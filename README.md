...
__Canvas Discussion Participation:__ 10% of your grade will be based on your regular participation on the Canvas discussion board for each chapter. You should post meaningful questions when you have them and help answer other student’s questions. Though this grade is subjective, students should consider one high quality post per chapter to be the criteria for full credit. _Please note that participation in chats during Zoom, or live lectures, is not required and does not contribute to this score. We are using Canvas for class participation so that students in different time zones can participate._
